...
/*  Dumped At       : 15:40 09/05/2026 (GMT)
/*  Total Offsets   : 391
/* -------------------------------------------------------------
/*  Join the discord!                                           
...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-bf6344c9c23446bf";
    }
    ...
    public static class Animator {
         public const long ActiveAnimations = 0x868;
    }
    ...
    public static class DataModel {
         ...
         public const long GameLoaded = 0x620;
         public const long JobId = 0x138;
         public const long PlaceId = 0x1a0;
         public const long PlaceVersion = 0x1bc;
         public const long PrimitiveCount = 0x468;
         public const long ScriptContext = 0x400;
         public const long ServerIP = 0x608;
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x749cbd8;
    ...
    public static class Instance {
         ...
         public const long ClassBase = 0x4728;
    ...
    public static class Player {
         ...
         public const long Mouse = 0x1168;
    ...
    public static class PlayerConfigurer {
         public const long Pointer = 0x74a1ca0;
    }
    ...
    public static class Sound {
         public const long Looped = 0x151;
         public const long PlaybackSpeed = 0x130;
         public const long Playing = 0x154;
    ...
    public static class SpawnLocation {
         public const long AllowTeamChangeOnTouch = 0x44;
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x7ba3198;
    }
    ...
    public static class Terrain {
         ...
         public const long MaterialColors = 0x2a8;
    ...
    public static class Tool {
         ...
         public const long Enabled = 0x2b4;
    ...
    public static class UserInputService {
         public const long WindowInputState = 0x298;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x7b79a08;
    ...
    public static class Workspace {
         public const long CurrentCamera = 0x490;
         public const long DistributedGameTime = 0x4b0;
         public const long ReadOnlyGravity = 0x9c0;
